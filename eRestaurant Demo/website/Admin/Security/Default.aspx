            ...
            <asp:ListView ID="UserListView" 
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Label Text="<%# Item.UserName %>" runat="server" ID="UserNameLabel"></asp:Label>              
                        </td>
                        <td>
                            <asp:Label Text="<%# Item.Email %>" runat="server" ID="EmailLabel"></asp:Label>
                        </td>
                    </tr>
                </ItemTemplate>
                <EmptyDataTemplate> 
                ...
                <EmptyDataTemplate>
                    <tr>
                        <td>
                            ...
                            <asp:LinkButton runat="server" ID="AddDefaultRolesButton" Text="Add default security roles" CommandName="AddDefaultRoles"></asp:LinkButton>
                        </td>
                    </tr>
                </EmptyDataTemplate>
            </asp:ListView>
