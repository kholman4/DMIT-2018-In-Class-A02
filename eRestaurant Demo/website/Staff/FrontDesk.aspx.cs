...
public partial class Staff_FrontDesk : System.Web.UI.Page
{
    ...
    protected void MockLastBillingDateTime_Click(object sender, EventArgs e)
    {
        ...
        //formatting data for use in an <input type="date"> HTML5 control
        SearchDate.Text = info.ToString("yyyy-MM-dd");

        //formattin time for use in an <input type="time"> HTML5 control
        SearchTime.Text = info.ToString("HH:mm:ss"); //HH is 24 hour clock, hh is 12
    }
}